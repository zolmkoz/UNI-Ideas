...
}function tmpl_draw_select_opt($values, $names, $selected)
{
	...
	if (count($galleries) > 1) {
		...
		$select = '<form id="avsel" method="post" action="/uni-ideas/index.php?t=avatarsel">'._hs.'
...
<a href="javascript: window.opener.document.forms[\'fud_register\'].reg_avatar.value=\''.$r[0].'\'; window.opener.document.reg_avatar_img.src=\'/uni-ideas/images/avatars/'.$r[2].'\'; window.close();"><img src="/uni-ideas/images/avatars/'.$r[2].'" alt="" />
<br />
