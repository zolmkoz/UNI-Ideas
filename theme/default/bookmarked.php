...
<tr>
	...
	if ($FUD_OPT_2 & 32768) {
		$pager = tmpl_create_pager($start, $THREADS_PER_PAGE, $total, '/uni-ideas/index.php/bml/start/', '/'. _rsid .'#fff');
	} else {
		$pager = tmpl_create_pager($start, $THREADS_PER_PAGE, $total, '/uni-ideas/index.php?t=bookmarked&a=1&'. _rsid, '#fff');
	}
