		...
		if ($cat != $cid && !$frm_id) {
			if ($cbuf) { /* If previous category was using compact view, print forum row. */
				if (empty($collapse[$i[4]])) { /* Only show if parent is not collapsed as well. */
					...
					<tr class="row child-c'.$cat.'">
						<td class="RowStyleA wo hide2">&nbsp;</td>
						<td class="RowStyleB ac wo hide2">&nbsp;</td>
						<td  class="RowStyleA wa">Available Forums:'.$cbuf.'</td>
				</tr>';
				}
				$cbuf = '';
			}
...
<a href="'.(empty($r[12]) ? '/uni-ideas/index.php?t='.t_thread_view.'&amp;frm_id='.$r[7].'&amp;'._rsid : $r[12] )  .'">'.$r[10].'</a>';
	...
	<td class="RowStyleA">'.$r[10].($r[11] ? '<br />'.$r[11] : '').'</td>
</tr>';
			continue;
		}
		...
		if (!_uid) { /* Anon user. */
			$forum_read_indicator = '<img style="margin-top: 10px" title="Only registered forum members can track read &amp; unread messages" src="/uni-ideas/theme/default/images/existing_content.png" alt="Only registered forum members can track read &amp; unread messages" width="30" height="30" />';
...
<body style="background-color: #ffffff;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
<!--HEADER-->
...
<div style="display:flex;align-items: center;justify-content:center"><img src="/uni-ideas/theme/default/images/shake-up-sales-meeting-og.jpg" style="width:60%; height: 60%;"></div>
...
<table width="100%">
	<tr>
		<td>
			...
			<span id="ShowLinks">
			<h1 style="text-align: center; font-weight: bold">Welcome to your Categories!</h1>
			<!-- <span style="font-size: 20px; color: black; font-weight: bold">Show</span> -->
			<a style=" text-decoration: none; color: #2B3467; font-weight: bold;font-size: 20px;margin-left: 55%;" href="/uni-ideas/index.php?t=selmsg&amp;date=today&amp;<?php echo _rsid; ?>&amp;frm_id=<?php echo (isset($frm->forum_id) ? $frm->forum_id.'' : $frm->id.'' )  .'&amp;th='.$th.'" title="Show all messages that were posted today" rel="nofollow">Today&#39;s Messages</a>
			'.(_uid ? '<b style="color: #2B3467;">|</b><a style="text-decoration: none; color: #2B3467; font-weight: bold;font-size: 20px" href="/uni-ideas/index.php?t=selmsg&amp;unread=1&amp;'._rsid.'&amp;frm_id='.(isset($frm->forum_id) ? $frm->forum_id.'' : $frm->id.'' )  .'" title="Show all unread messages" rel="nofollow">&nbsp;Unread Messages</a>&nbsp;' : ''); ?>
			<?php echo (!$th ? '<b style="color: #344CB7;">|</b> <a href="/uni-ideas/index.php?t=selmsg&amp;reply_count=0&amp;'._rsid.'&amp;frm_id='.(isset($frm->forum_id) ? $frm->forum_id.'' : $frm->id.'' )  .'" title="Show all messages, which have no replies" rel="nofollow" style=" text-decoration: none; color: #2B3467; font-weight: bold; font-size: 20px">Unanswered Messages</a>&nbsp;' : ''); ?>
			<b style='color: #2B3467;'>|</b> <a style='text-decoration: none; color: #2B3467; font-weight: bold;font-size: 20px' href='/uni-ideas/index.php?t=polllist&amp;<?php echo _rsid; ?>' rel='nofollow'>Polls</a>
			<b style='color: #2B3467;'>|</b> <a style=' text-decoration: none; color: #2B3467; font-weight: bold;font-size: 20px' href='/uni-ideas/index.php?t=mnav&amp;<?php echo _rsid; ?> rel='nofollow'>Message Navigator</a>
			</span>
			<?php echo $admin_cp; ?>
			<?php echo $cat_path; ?>
		</td>
				...
				<div class="w3-responsive">
					<table class="w3-table-all" style="border: none;">
						<tr style="border: none;border-top: 2px solid #000;font-weight: bold; font-size: 17px;">
							...
							<td style="width: 15%;text-align: center">Messages</td>
							<td style="width: 15%;text-align: center">Topics</td>
							<td style="width: 15%;text-align: center">Last Message</td>
						</tr>
						'.$forum_list_table_data.'
					</table>
				</div>
