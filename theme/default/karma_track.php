...
function logaction($user_id, $res, $res_id=0, $action=null)
{
	...
	<td>'.$r[0].'</td>
	<td>'.$r[1].'</td>
	<td><a href="/uni-ideas/index.php?t=msg&amp;goto='.$r[3].'#msg_'.$r[3].'" target="_blank">'.$r[3].'</a></td>
	<td><a href="/uni-ideas/index.php?t=karma_track&amp;msgid='.$r[3].'&amp;karmaid='.$r[2].'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Delete</a></td>
</tr>';
	}
	unset($c);
