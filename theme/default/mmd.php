...
/* Print number of unread private messages in User Control Panel. */
	...
	if ($final_del) { /* Remove threads, one by one. */
		...
		header('Location: /uni-ideas/index.php?t=merge_th&frm_id='. $perms[0] .'&new_title='. urlencode($new_title) .'&sel_th='. serialize($sel_th) .'&'. _rsidl);
		exit;
	}
...
<form method="post" action="/uni-ideas/index.php?t=mmd"><?php echo _hs; ?>
<div align="center">
