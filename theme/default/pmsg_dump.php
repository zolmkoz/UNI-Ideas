...
<tr>
	<td class="MsgR1 al vt"><b>Subject:</b> '.$obj->subject.'</td>
	<td class="MsgR1 ar vt DateText"><b>By:</b> '.filter_var($obj->alias, FILTER_SANITIZE_STRING).' <b>on</b> '.utf8_encode(strftime('%a, %d %B %Y %H:%M', $obj->post_stamp)).'</td>
</tr>
<tr>
...
<body>
	<div class="content">
		...
		<?php echo $pm_data; ?>
		<small>Exported: <?php echo utf8_encode(strftime('%a %b %d %H:%M:%S %Z %Y', __request_timestamp__)); ?></small>
	</div>
</body>
</html>