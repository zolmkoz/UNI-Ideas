...
function reverse_fmt($data)
{
	...
	<td class="nw">
		[<a href="/uni-ideas/index.php?t=poll&amp;frm_id='.$frm_id.'&amp;'._rsid.'&amp;pl_id='.$pl_id.'&amp;pl_optedit='.$k.'">Edit</a>]
		[<a href="/uni-ideas/index.php?t=poll&amp;frm_id='.$frm_id.'&amp;pl_id='.$pl_id.'&amp;del_id='.$k.'&amp;'._rsid.'">Delete</a>]
	</td>
</tr>';
		}
...
<form action="/uni-ideas/index.php?t=poll" method="post" id="poll_submit">
...
<tr>
	<td colspan="2" class="ar"><?php echo (!$pl_id ? '<input tabindex="5" type="submit" class="button" name="pl_submit" value="Create Poll" />' : '<input tabindex="5" type="submit" class="button" name="pl_submit" value="Update Poll" />'); ?></td>
</tr>
</table>
<br />
