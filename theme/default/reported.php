...
if (_uid) {
	...
	<td class="RowStyleC">
		<div class="MsgR1">
			<b>Reported By:</b>
			'.($obj->report_user_id ? '<a href="/uni-ideas/index.php?t=usrinfo&amp;id='.$obj->report_user_id.'&amp;'._rsid.'">'.$obj->report_user_login.'</a>' : $GLOBALS['ANON_NICK'].'' ) .'
			<b>On:</b>
			'.utf8_encode(strftime('%a, %d %B %Y %H:%M', $obj->report_stamp)).'
			<b>In:</b>
			'.draw_path($obj->cat_id).$obj->frm_name.' &raquo; 
			<a href="/uni-ideas/index.php?t='.d_thread_view.'&amp;goto='.$obj->id.'&amp;'._rsid.'#msg_'.$obj->id.'">'.$obj->thread_subject.'</a>
		</div>
		<div class="MsgR2">
			<b>Reason:</b> '.$obj->report_reason.'
			<br />
			[ <a href="/uni-ideas/index.php?t=reported&amp;'._rsid.'&amp;del='.$obj->report_id.'&amp;SQ='.$GLOBALS['sq'].'">Delete Report</a> ]
		</div>
	</td>
</tr>
'.tmpl_drawmsg($obj, $usr, $perms, false, $n, null);
	...
	if (!$reported_message) {
		$reported_message = '<tr>
	<td>There are no reported messages.</td>
</tr>';
	}
