...
<div class="ctb">
<form method="post" action="/uni-ideas/index.php?t=reset">
<table cellspacing="1" cellpadding="2" class="DialogTable">
<tr>
	<th colspan="2">Password Reminder</th>
</tr>
<tr>
	<td colspan="2" class="RowStyleA GenText">Your password will be reset and sent to you. If you have not yet confirmed your e-mail address, the confirmation request will be re-sent to you.</td>
</tr>
<tr class="RowStyleB">
...
<tr class="RowStyleA">
	<td class="nw ar" colspan="2"><input type="submit" class="button" name="reset_passwd" value="Reset Password" /></td>
</tr>
</table>
<?php echo _hs; ?>
</form>
