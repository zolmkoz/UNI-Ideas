...
}function get_host($ip)
{
	...
	if (isset($_GET['appr']) && ($thrx = thx_get((int)$_GET['appr']))) {
		...
		if (!empty($_POST['reason'])) {
			...
			$thr_exch_data = '<form method="post" action="/uni-ideas/index.php?t=thr_exch" name="thr_exch">
...
<tr class="RowStyleB">
	<td class="al nw vt SmallText"><b>Topic move requested by:</b> <a href="/uni-ideas/index.php?t=usrinfo&amp;id='.$obj->req_by.'&amp;'._rsid.'">'.filter_var($obj->alias, FILTER_SANITIZE_STRING).'</a><br /></td>
...
<tr class="RowStyleC">
	<td colspan="2">
		<table border="0" cellspacing="0" cellpadding="3" class="wa">
		<tr>
			<td class="al SmallText"><b>Original Forum:</b> '.$obj->sf_name.'<br /><b>Destination Forum:</b> '.$obj->df_name.'<br /><b>Topic:</b> <a href="/uni-ideas/index.php?t=msg&amp;'._rsid.'&amp;th='.$obj->th.'">'.$obj->subject.'</a></td>
			<td class="ar">[<a href="/uni-ideas/index.php?t=thr_exch&amp;appr='.$obj->id.'&amp;'._rsid.'">accept topic</a>]&nbsp;&nbsp;[<a href="/uni-ideas/index.php?t=thr_exch&amp;decl='.$obj->id.'&amp;'._rsid.'">decline topic</a>]</td>
		</tr>
		</table>
	</td>
</tr>
